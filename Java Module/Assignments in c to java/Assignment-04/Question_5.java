...
public class Question_5 {
    ...
    public static void main(String[] args) {
            int choice=2,num=10,temp,rev,sum,digit;
    System.out.printf("MENU\n");
    System.out.printf("Enter your choice from the following:\n");
...
//even or odd
    if (choice==1)
    {
        System.out.printf("even and odd numbers from 1 to %d\n",num);
        for (int  i = 1; i <=num; i++)
        {
            if (i%2==0)
        {
...
//prime or not
    ...
    {
    int flag=1;
    System.out.printf("prime number between 1 to %d is :\n",num);
      if (num<=1)
    {
    ...
    else if (choice==4)
{
    ...
    else if(num<0)
    {
        ...
        System.out.printf("the numer is a zero");
    }
...
else if (choice==5)
{
   ...
   System.out.printf("Reverse order of the number is %d",rev);
}
