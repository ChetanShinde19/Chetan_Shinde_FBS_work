...
public class Question_02 {
	...
	public static void main(String[] args) {
		...
		Bus bus1=new Bus("MH10DJ1900","V7L", "VOLVO", 10, 8000000L, 50, 0);
		
		Bike bike1=new Bike("MH10DG5526", "GT 650", "Royal Enfield", 2, 2, 2, "Roadster/Street Bike", 300000);
		
		Car car1=new Car("MH10CS0019", "M5", "BMW", 4, 9000000, "Yes", "Sports", "Active");
